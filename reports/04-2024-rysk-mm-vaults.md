...
- [Low Findings](#low-findings)
  - [1. Low - `takeGas()` should return excess ETH sent by mistake](#1-low---takegas-should-return-excess-eth-sent-by-mistake)
    - [Technical Details](#technical-details)
    - [Impact](#impact)
    - [Recommendation](#recommendation)
    - [Developer Response](#developer-response)
  - [2. Low - Unintended queue item skipping in `processQueue()`](#2-low---unintended-queue-item-skipping-in-processqueue)
    - [Technical Details](#technical-details-1)
    - [Impact](#impact-1)
    - [Recommendation](#recommendation-1)
    - [Developer Response](#developer-response-1)
  - [3. Low - Verify deposit amount is above minimum amount](#3-low---verify-deposit-amount-is-above-minimum-amount)
...
- [Gas Saving Findings](#gas-saving-findings)
  - [1. Gas - Structure can be packed into fewer storage slots](#1-gas---structure-can-be-packed-into-fewer-storage-slots)
    - [Technical Details](#technical-details-3)
    - [Impact](#impact-3)
    - [Recommendation](#recommendation-3)
    - [Developer Response](#developer-response-3)
  - [2. Gas - Use a circular buffer instead of an indefinitely growing queue](#2-gas---use-a-circular-buffer-instead-of-an-indefinitely-growing-queue)
    - [Technical Details](#technical-details-4)
    - [Impact](#impact-4)
    - [Recommendation](#recommendation-4)
    - [Developer Response](#developer-response-4)
  - [3. Gas - Optimize `queueCounter`](#3-gas---optimize-queuecounter)
    - [Technical Details](#technical-details-5)
    - [Impact](#impact-5)
    - [Recommendation](#recommendation-5)
    - [Developer Response](#developer-response-5)
- [Informational Findings](#informational-findings)
  - [1. Informational - Unused import](#1-informational---unused-import)
    - [Technical Details](#technical-details-6)
    - [Impact](#impact-6)
    - [Recommendation](#recommendation-6)
    - [Developer Response](#developer-response-6)
  - [2. Informational - Typos](#2-informational---typos)
    - [Technical Details](#technical-details-7)
    - [Impact](#impact-7)
    - [Recommendation](#recommendation-7)
    - [Developer Response](#developer-response-7)
  - [3. Informational - Refactor duplicated require()/revert() checks into a modifier or function](#3-informational---refactor-duplicated-requirerevert-checks-into-a-modifier-or-function)
    - [Technical Details](#technical-details-8)
    - [Impact](#impact-8)
    - [Recommendation](#recommendation-8)
    - [Developer Response](#developer-response-8)
  - [4. Informational - Unused error string](#4-informational---unused-error-string)
    - [Technical Details](#technical-details-9)
    - [Impact](#impact-9)
    - [Recommendation](#recommendation-9)
    - [Developer Response](#developer-response-9)
  - [5. Informational - Setters should have boundaries](#5-informational---setters-should-have-boundaries)
    - [Technical Details](#technical-details-10)
    - [Impact](#impact-10)
    - [Recommendation](#recommendation-10)
    - [Developer Response](#developer-response-10)
  - [6. Informational - `approvedSigner` can't be updated](#6-informational---approvedsigner-cant-be-updated)
    - [Technical Details](#technical-details-11)
    - [Impact](#impact-11)
    - [Recommendation](#recommendation-11)
    - [Developer Response](#developer-response-11)
  - [7. Informational - Replace magic numbers with constants](#7-informational---replace-magic-numbers-with-constants)
    - [Technical Details](#technical-details-12)
    - [Impact](#impact-12)
    - [Recommendation](#recommendation-12)
    - [Developer Response](#developer-response-12)
  - [8. Informational - Use OpenZeppelin `forceApprove()` instead of approve](#8-informational---use-openzeppelin-forceapprove-instead-of-approve)
    - [Technical Details](#technical-details-13)
    - [Impact](#impact-13)
    - [Recommendation](#recommendation-13)
    - [Developer Response](#developer-response-13)
  - [9. Informational - Missing event emits](#9-informational---missing-event-emits)
    - [Technical Details](#technical-details-14)
    - [Impact](#impact-14)
    - [Recommendation](#recommendation-14)
    - [Developer Response](#developer-response-14)
  - [10. Informational - Change the value of `processQueueGasUsage`](#10-informational---change-the-value-of-processqueuegasusage)
